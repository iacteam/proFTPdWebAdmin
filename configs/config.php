...
$cfg['db_host'] = getenv("mySqlHostname");
$cfg['db_name'] = getenv("mySqlDBName");
$cfg['db_user'] = getenv("mySqlUsername");
$cfg['db_pass'] = getenv("mySqlPassword");
