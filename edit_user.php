...
$field_keypair  = $cfg['field_keypair'];
...
if (empty($errormsg) && !empty($_REQUEST["action"]) && $_REQUEST["action"] == "update") {
  ...
  if (count($errors) == 0) {
    ...
    $userdata = array($field_id       => $_REQUEST[$field_id],
                      ...
                      $field_keypair  => $_REQUEST[$field_keypair],
...
if (empty($errormsg)) {
  ...
  $keypair  = $_REQUEST[$field_keypair];
    ...
    <div class="panel-body collapse in" id="userprops" aria-expanded="true">
      <div class="col-sm-12">
        <form role="form" class="form-horizontal" method="post" data-toggle="validator">
          ...
          <!-- KeyPair -->
          <div class="form-group">
            <label for="<?php echo $field_keypair; ?>" class="col-sm-4 control-label">KeyPair</label>
            <div class="controls col-sm-8">
              <input type="text" class="form-control" id="<?php echo $field_keypair; ?>" name="<?php echo $field_keypair; ?>" value="<?php echo $keypair; ?>" placeholder="Change Keypair" />
            </div>
          </div>
          <!-- Home directory -->
          <div class="form-group">
